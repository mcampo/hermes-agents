...
SPREADSHEET_ID = "1FlO3LLSWQmTRoKL8WFeYQKQ-GZWU3HW4zbKgfFuHPqw"
DRIVE_ROOT_ID = os.environ["GASTOS_VENCIMIENTOS_DRIVE_ROOT_ID"]
DRIVE_ROOT_NAME = "Vencimientos"
...
def _verify_root(drive) -> None:
    ...
    if (
        ...
        raise RuntimeError("configured Drive root identity failed")
